...
class Profile:
    def __init__(self, name=None, email=None, gender=None, gender_acc=None, is_bot=False, country=None):
        self.name = name
        self.email = email
        self.gender = gender
...
class Enrollment:
    def __init__(self, group=None, start=None, end=None, organization=None, individual=None):
        self.group = group
        self.start = start
        self.end = end
